				...
				okButton.addActionListener(new ActionListener(){  
					public void actionPerformed(ActionEvent e){ 
						...
						if(textField_X.getText().trim().isEmpty()||
							...
							isOk = true;
							circle = new Circle(new Point(Integer.parseInt(textField_X.getText()),Integer.parseInt(textField_Y.getText())),Integer.parseInt(textField_Radius.getText()),false,lineColor,innerColor);
							dispose();
						}		
					}else {
						if(textField_X.getText().trim().isEmpty()||
							...
							isOk = true;
							circle = new Circle(new Point(Integer.parseInt(textField_X.getText()), Integer.parseInt(textField_Y.getText())),Integer.parseInt(textField_Radius.getText()),false,lineColor,innerColor);
							//circle.newCenter(Integer.parseInt(textField_X.getText()), Integer.parseInt(textField_Y.getText()));
							//circle.setRadius(Integer.parseInt(textField_Radius.getText()));
